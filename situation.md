...
- Escolher e escafoldar o frontend, e implementar a página de cadastro (formulário principal) consumindo `POST /medicoes`.
- Implementar a página de relatório (filtros + export CSV/XLS) — endpoint de export ainda não existe no backend.
